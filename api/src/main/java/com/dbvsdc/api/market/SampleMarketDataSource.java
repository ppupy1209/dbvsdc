...
public class SampleMarketDataSource implements MarketDataSource {
    ...
    private static Map<String, List<Double>> createReturns() {
        ...
        returns.put("ks", List.of(33.53, 11.34, 55.75, 6.29, 31.94, -37.54, 53.4, 24.03, -10.41, 12.65, 1.92, -5.84, 0.3, 9.97, 26.7, -17.53, 13.93, 34.32, 3.06, -24.35, 24.78, -9.42, 92.47));
        returns.put("kq", List.of(-14.62, 53.8, -16.95, -10.62, 50.22, -1.57, -35.66, 45.18, -19.0, 37.37));
